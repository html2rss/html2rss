...
RSpec.describe Html2rss::Test do
  ...
  describe '.call' do
    context 'when schema validation fails' do
      it 'returns a failed TestResult with validation errors', :aggregate_failures do
    ...
    context 'when schema is valid and items are extracted' do
      ...
      it 'returns a successful TestResult with article count and sample items', :aggregate_failures do
    ...
    context 'when live extraction raises an error' do
      ...
      it 'returns a failed TestResult with error message', :aggregate_failures do
