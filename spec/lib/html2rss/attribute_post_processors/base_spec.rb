...
RSpec.describe Html2rss::AttributePostProcessors::Base do
  ...
  describe '.expect_options' do
    ...
    it 'raises an error if a key is missing' do
      ...
      end.to raise_error(Html2rss::AttributePostProcessors::MissingOption, /The `key3` option is missing in:/)
    end
  end
