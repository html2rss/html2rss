...
- Never write source documentation into `docs/`. That directory is generated YARD HTML only; regenerate with `make docs`. Living module guides live next to the owning code (`lib/html2rss/auto_source/README.md`, `lib/html2rss/capture/README.md`, `lib/html2rss/feed_pipeline/README.md`).
