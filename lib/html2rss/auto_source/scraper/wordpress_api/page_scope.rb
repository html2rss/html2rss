      ...
      class WordpressApi
        ...
        class PageScope
          ...
          def self.from(parsed_body:, url:)
            allocate.tap { _1.send(:setup_context, parsed_body:, url:) }.send(:resolve)
          end
          ...
          def setup_context(parsed_body:, url:)
          ...
          def date_scope
            ...
            self.class.new(query: range, fetchable: true)
          end

          def fallback_scope
            return unknown_archive_scope if archive_like?

            self.class.new(query: {}, fetchable: true)
          end
          ...
          def unknown_archive_scope
            self.class.new(query: {}, fetchable: false)
          end
