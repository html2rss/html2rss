...
- `gsub` rejects a `pattern` whose slash-stripped source exceeds 256 bytes or whose star-height is greater than 1; `Html2rss.validate` and extraction share that compile.
